function getDepartmentList(){
	...
	function(data){
		...
		departmentList = "";
		for(var i in re){
			departmentList += "<option value='"+re[i].groupID+"'>"+re[i].department+"</option>";
		}
...
function getClassList(){
	...
	function(data){
		...
		classList = "";
		for(var i in re){
			classList += "<option value='"+re[i].groupID+"'>"+re[i].class+"</option>";
		}
