<legend>操作</legend>
<a href="/goods/newGoods?shopID=<?php echo $_GET['id']; ?>"  style="margin: 0 0 20px 20px" class="btn btn-default">创建商品</a>
<a href="/shop/selectGoods?id=<?php echo $_GET['id']; ?>"  style="margin: 0 0 20px 20px" class="btn btn-default">我的商品</a><br/>
<legend>商品列表</legend>
