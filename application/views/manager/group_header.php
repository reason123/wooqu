<div id="manager_nav" style="margin-bottom: 10px;">
    <div class="nav nav-pills">
        <li <?php if($mgh=='activity') echo 'class="active"' ?>><a href="/manager/examine">活动审批</a></li>
        <li <?php if($mgh=='announcement') echo 'class="active"' ?>><a href="/manager/announcement">公告管理[未开放]</a></li>
