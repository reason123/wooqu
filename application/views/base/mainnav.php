...
<html>
	...
	<body>
		<div class="hide-side-bar<?php if (isset($_SESSION["loginName"]) && false) echo " auto-hide-sidebar"; ?>" id="left-sidebar">
		...
		<div class = "container row" id="maincontent<?php if (!isset($_SESSION["loginName"]) || true) echo "-nologin"; ?>"> 
